  ...
  const questions = [
    {
      ...
      options: ["Here’s a quick update.", "I do not know.", "Wait a minute."],
      answer: 0,
    },
    {
      ...
      <main className="min-h-screen bg-black text-white px-6 py-12">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-gray-400 text-lg mb-10">
            Practice speaking clearly in meetings, giving updates, asking
            questions, and responding professionally.
          </p>

          <section className="bg-gray-900 rounded-xl p-6 mb-8">
            <h2 className="text-2xl font-semibold mb-4">Lesson Objective</h2>
            <p className="text-gray-300">
              By the end of this lesson, students should be able to communicate
              clearly during meetings and explain progress in professional
              English.
            </p>
          </section>
          ...
          <section className="bg-gray-900 rounded-xl p-6 mt-8">
            ...
            <p className="text-gray-400 mt-3 italic">
              “I want to update my team about a bug we are fixing and ask one
              question before the meeting ends.”
            </p>
          </section>

          <section className="bg-gray-900 rounded-xl p-6 mt-10">
            <h2 className="text-2xl font-semibold mb-6">
              CGA (Check Your Understanding)
            </h2>
